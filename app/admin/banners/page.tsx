            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-100 bg-gray-50">
                  <th className="text-left px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider">이미지</th>
              ...
              <tbody className="divide-y divide-gray-50">
                {banners.map((banner) => (
                  <tr key={banner.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-3 text-sm text-gray-900 max-w-xs truncate">{banner.title}</td>
                    ...
                    <td className="px-6 py-3 text-sm text-gray-500">{banner.sort_order}</td>
